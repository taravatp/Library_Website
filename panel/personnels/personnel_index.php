...
$result = mysqli_query($con, "select * from users where role='personnel'");
...
?>
<head>
    <title>کتابداران کتاب خانه</title>
...
<div class="container">
    <div class="insert">
        <a href="personnel_create.php">
            <button type="button" class="btn btn-success btn-lg">کتابدار جدید</button>
        </a>
    </div>
    <div class="card">

        <div class="card-header">
            <p>مدیریت کتابدار ها</p>
        </div>
            ...
            <table class="table table-hover table-bordered">
                ...
                <?php while ($rows = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <a href="personnel_view.php?id=<?php echo $rows['id']; ?>">
                                <button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
                            </a>
                            <a href="personnel_edit.php?id=<?php echo $rows['id']; ?>">
                                <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                            </a>
                            <form method="post" action="personnel_index.php" class="delete-from">
