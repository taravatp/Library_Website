...
if (isset($_POST['submit'])) {
    ...
    $query = "insert into books(image,name,price,code,genre,author,publicationDate,publisher,coverType,numberOfPages,paperType,textColor,description,posetdBy) values('$image','$name','$price','$code','$genre','$author','$year','$publisher','$coverType','$numberOfPages','$paperType','$textColor','$description','$postedBy')";
    if (!mysqli_query($con, $query)) {
        die('error creating book: ' . mysqli_error($con));
    } else {
        ...
        <div style="direction: rtl">
            <ul class="navbar-nav mr-auto" style="direction: rtl">
                ...
                <?php if ($_SESSION['role'] == "manager") { ?>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="../personnels/personnel_index.php">مدیریت کارکنان<span class="sr-only"></span></a>
                    </li>
                <?php } ?>
...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-12 ">
            <form action="book_create.php" method="post" enctype="multipart/form-data" class="m-0 p-0" id="form_book">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="coverType" id="coverType" class="form-control">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="paperType" id="paperType" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <textarea class="form-control" rows="6" name="description" autocomplete="off"
                                          placeholder="خلاصه ای از کتاب را وارد کنید..."></textarea>
                            </div>
                        </div>
                    </div>
