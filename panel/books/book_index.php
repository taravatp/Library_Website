...
<div class="container">
    <div class="insert">
        <a href="book_create.php">
            <button type="button" class="btn btn-success btn-lg">ثبت کتاب</button>
        </a>
    </div>
    <div class="card">
            ...
            <table class="table table-hover table-bordered">
                ...
                <?php while ($rows = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <a href="book_view.php?id=<?php echo $rows['id']; ?>">
                                <button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
                            </a>
                            <a href="book_edit.php?id=<?php echo $rows['id']; ?>">
                                <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                            </a>
                            <form method="post" action="book_index.php" class="delete-from">
