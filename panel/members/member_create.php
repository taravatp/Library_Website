...
<div class="container my-5">
    <form action="member_create.php" method="post" enctype="multipart/form-data" id="registration_form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fname" id="fname" class="form-control" placeholder="طراوت" autocomplete="off">
                            <p id="fname_error_message" style="color: red"></p>
                        </div>

                        <div class="form-group">
                            <label for="lname">نام خانوادگی:</label>
                            <input type="text" name="lname" id="lname" class="form-control" placeholder="پارت" autocomplete="off">
                            <p id="lname_error_message" style="color: red"></p>
                        </div>

                        <div class="form-group">
                            <label for="nationalID">کد ملی:</label>
                            <input type="number" name="nationalID" id="nationalID" class="form-control" placeholder="0123456789" autocomplete="off">
                            <p id="nationalID_error_message" style="color: red"></p>
                        </div>

                        <div class="form-group">
                            <label for="phone">شماره تماس:</label>
                            <input type="text" name="phone" id="phone" class="form-control" placeholder="09xx-xxx-xxxx" autocomplete="off">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" id="username" class="form-control" placeholder="نام کاربری" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="confirm" id="confirm" class="form-control" autocomplete="off">
