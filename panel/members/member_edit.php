...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-lg-8">
            <form action="member_edit.php" method="post" enctype="multipart/form-data" id="form_edit">
                        ...
                        <div class="row selects">
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="gender" value="<?php echo $row['gender']; ?>"
                                        name="gender">
                                    <option <?php if($row['role']=="female"){ echo "selected";}?>>
                                        زن
                                    </option>
                                    <option <?php if($row['role']=="male"){ echo "selected";}?>>
                                        مرد
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="role" value="<?php echo $row['role']; ?>" name="role">
                                    <option <?php if($row['role']=="manager"){ echo "selected";}?>>
                                        مدیر
                                    </option>
                                    <option <?php if($row['role']=="personnel"){ echo "selected";}?>>
                                        کارمند
                                    </option>
                                    <option <?php if($row['role']=="member"){ echo "selected";}?>>
                                        کاربر
                                    </option>
                                </select>
                            </div>
        ...
        <div class="col-lg-4">
            <form action="member_edit.php" method="post" enctype="multipart/form-data" id="form_change_password">
                <div class="card">
                    <div class="card-header">
                        <p>ویرایش رمز عبور</p>
                    </div>
